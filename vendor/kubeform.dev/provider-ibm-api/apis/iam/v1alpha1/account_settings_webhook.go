...
var accountsettingsForceNewList = map[string]bool{}
...
func (r *AccountSettings) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range accountsettingsForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`accountsettings "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
