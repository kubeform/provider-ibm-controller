...
type NetworkSpecResource struct {
	...
	// PI network CIDR
	// +optional
	PiCIDR *string `json:"piCIDR,omitempty" tf:"pi_cidr"`
	// PI cloud instance ID
	PiCloudInstanceID *string `json:"piCloudInstanceID" tf:"pi_cloud_instance_id"`
	// List of PI network DNS name
	// +optional
	PiDNS []string `json:"piDNS,omitempty" tf:"pi_dns"`
	// PI network gateway
	// +optional
	PiGateway *string `json:"piGateway,omitempty" tf:"pi_gateway"`
	// PI network name
	PiNetworkName *string `json:"piNetworkName" tf:"pi_network_name"`
	// PI network type
	PiNetworkType *string `json:"piNetworkType" tf:"pi_network_type"`
	// VLAN Id value
	// +optional
