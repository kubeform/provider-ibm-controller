...
type NetworkPort struct {
	...
	Spec              NetworkPortSpec   `json:"spec,omitempty"`
	Status            NetworkPortStatus `json:"status,omitempty"`
}

type NetworkPortSpec struct {
	State *NetworkPortSpecResource `json:"state,omitempty" tf:"-"`

	Resource NetworkPortSpecResource `json:"resource" tf:"resource"`
...
type NetworkPortSpecResource struct {
	...
	// +optional
	PiNetworkPortIpaddress *string `json:"piNetworkPortIpaddress,omitempty" tf:"pi_network_port_ipaddress"`
	// +optional
	Portid *string `json:"portid,omitempty" tf:"portid"`
	// +optional
...
type NetworkPortList struct {
	...
	// Items is a list of NetworkPort CRD objects
	Items []NetworkPort `json:"items,omitempty"`
}
