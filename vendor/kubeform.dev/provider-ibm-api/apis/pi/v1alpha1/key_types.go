...
type KeySpecResource struct {
	...
	// Date info
	// +optional
	PiCreationDate *string `json:"piCreationDate,omitempty" tf:"pi_creation_date"`
	// Key name in the PI instance
	PiKeyName *string `json:"piKeyName" tf:"pi_key_name"`
	// PI instance key info
	PiSSHKey *string `json:"piSSHKey" tf:"pi_ssh_key"`
}
