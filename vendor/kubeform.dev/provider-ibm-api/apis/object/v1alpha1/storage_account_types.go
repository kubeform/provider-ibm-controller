...
type StorageAccountSpec struct {
	State *StorageAccountSpecResource `json:"state,omitempty" tf:"-"`

	Resource StorageAccountSpecResource `json:"resource" tf:"resource"`
...
type StorageAccountSpecResource struct {
	ID string `json:"id,omitempty" tf:"id,omitempty"`

	// +optional
	LocalNote *string `json:"localNote,omitempty" tf:"local_note"`
	// +optional
