...
type TriggerSpecFeed struct {
	// Trigger feed ACTION_NAME.
	Name *string `json:"name" tf:"name"`
	// Parameters values in KEY VALUE format. Parameter bindings included in the context passed to the action invoke.
	// +optional
...
type TriggerSpecResource struct {
	...
	// Trigger feed
	// +optional
	Feed *TriggerSpecFeed `json:"feed,omitempty" tf:"feed"`
	// Name of Trigger.
	Name *string `json:"name" tf:"name"`
