...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-is-ibm-kubeform-com-v1alpha1-instance,mutating=false,failurePolicy=fail,groups=is.ibm.kubeform.com,resources=instances,versions=v1alpha1,name=instance.is.ibm.kubeform.io,sideEffects=None,admissionReviewVersions=v1

var _ webhook.Validator = &Instance{}

var instanceForceNewList = map[string]bool{
	"/boot_volume/*/snapshot": true,
	"/dedicated_host":         true,
	"/dedicated_host_group":   true,
	"/image":                  true,
	"/instance_template":      true,
	"/network_interfaces/*/primary_ipv4_address":        true,
	"/network_interfaces/*/subnet":                      true,
	"/primary_network_interface/*/primary_ipv4_address": true,
