...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-is-ibm-kubeform-com-v1alpha1-instancetemplate,mutating=false,failurePolicy=fail,groups=is.ibm.kubeform.com,resources=instancetemplates,versions=v1alpha1,name=instancetemplate.is.ibm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
var instancetemplateForceNewList = map[string]bool{
	...
	"/image":                              true,
	"/network_interfaces/*/subnet":        true,
	"/primary_network_interface/*/subnet": true,
	"/profile":                            true,
	"/resource_group":                     true,
	"/user_data":                          true,
	"/volume_attachments/*/volume":        true,
	"/volume_attachments/*/volume_prototype/*/capacity":       true,
	"/volume_attachments/*/volume_prototype/*/encryption_key": true,
	"/volume_attachments/*/volume_prototype/*/iops":           true,
	"/volume_attachments/*/volume_prototype/*/profile":        true,
	"/vpc":  true,
	"/zone": true,
}
