...
import (
	...
	ibmscheme "kubeform.dev/provider-ibm-api/client/clientset/versioned/scheme"
...
func init() {
	_ = ibmscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform ibm Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-ibm-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "ibm.kubeform.com",
			})
			if err != nil {
