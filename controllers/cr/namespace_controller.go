...
// +kubebuilder:rbac:groups=cr.ibm.kubeform.com,resources=namespaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cr.ibm.kubeform.com,resources=namespaces/status,verbs=get;update;patch
