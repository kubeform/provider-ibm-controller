...
// +kubebuilder:rbac:groups=schematics.ibm.kubeform.com,resources=actions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=schematics.ibm.kubeform.com,resources=actions/status,verbs=get;update;patch
...
func (r *ActionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &schematicsv1alpha1.Action{}); err != nil {
			klog.Error(err, "unable to set up auditor", schematicsv1alpha1.Action{}.APIVersion, schematicsv1alpha1.Action{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&schematicsv1alpha1.Action{}).
