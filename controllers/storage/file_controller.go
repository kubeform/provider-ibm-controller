...
// +kubebuilder:rbac:groups=storage.ibm.kubeform.com,resources=files,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.ibm.kubeform.com,resources=files/status,verbs=get;update;patch
...
func (r *FileReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.File{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.File{}.APIVersion, storagev1alpha1.File{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&storagev1alpha1.File{}).
