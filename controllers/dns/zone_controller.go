...
// +kubebuilder:rbac:groups=dns.ibm.kubeform.com,resources=zones,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dns.ibm.kubeform.com,resources=zones/status,verbs=get;update;patch
...
func (r *ZoneReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dnsv1alpha1.Zone{}); err != nil {
			klog.Error(err, "unable to set up auditor", dnsv1alpha1.Zone{}.APIVersion, dnsv1alpha1.Zone{}.Kind)
			return err
		}
	}
