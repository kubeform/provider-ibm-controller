...
// +kubebuilder:rbac:groups=iam.ibm.kubeform.com,resources=apikeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.ibm.kubeform.com,resources=apikeys/status,verbs=get;update;patch
...
func (r *ApiKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.ApiKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.ApiKey{}.APIVersion, iamv1alpha1.ApiKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.ApiKey{}).
...
func (r *ApiKeyReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for ApiKey")
			return nil
		}
		...
		resourceList := &iamv1alpha1.ApiKeyList{}
