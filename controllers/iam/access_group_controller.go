...
// +kubebuilder:rbac:groups=iam.ibm.kubeform.com,resources=accessgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.ibm.kubeform.com,resources=accessgroups/status,verbs=get;update;patch
...
func (r *AccessGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.AccessGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.AccessGroup{}.APIVersion, iamv1alpha1.AccessGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.AccessGroup{}).
