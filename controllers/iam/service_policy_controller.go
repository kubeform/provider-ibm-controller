...
// +kubebuilder:rbac:groups=iam.ibm.kubeform.com,resources=servicepolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iam.ibm.kubeform.com,resources=servicepolicies/status,verbs=get;update;patch
...
func (r *ServicePolicyReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch ServicePolicy")
...
func (r *ServicePolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iamv1alpha1.ServicePolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", iamv1alpha1.ServicePolicy{}.APIVersion, iamv1alpha1.ServicePolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iamv1alpha1.ServicePolicy{}).
