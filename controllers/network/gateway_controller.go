...
// +kubebuilder:rbac:groups=network.ibm.kubeform.com,resources=gateways,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.ibm.kubeform.com,resources=gateways/status,verbs=get;update;patch
...
func (r *GatewayReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkv1alpha1.Gateway{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkv1alpha1.Gateway{}.APIVersion, networkv1alpha1.Gateway{}.Kind)
			return err
		}
	}
