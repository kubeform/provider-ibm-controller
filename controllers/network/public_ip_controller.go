...
// +kubebuilder:rbac:groups=network.ibm.kubeform.com,resources=publicips,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.ibm.kubeform.com,resources=publicips/status,verbs=get;update;patch
...
func (r *PublicIPReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch PublicIP")
...
func (r *PublicIPReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkv1alpha1.PublicIP{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkv1alpha1.PublicIP{}.APIVersion, networkv1alpha1.PublicIP{}.Kind)
			return err
		}
	}
