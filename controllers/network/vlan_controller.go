...
// +kubebuilder:rbac:groups=network.ibm.kubeform.com,resources=vlans,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.ibm.kubeform.com,resources=vlans/status,verbs=get;update;patch
...
func (r *VlanReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkv1alpha1.Vlan{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkv1alpha1.Vlan{}.APIVersion, networkv1alpha1.Vlan{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&networkv1alpha1.Vlan{}).
