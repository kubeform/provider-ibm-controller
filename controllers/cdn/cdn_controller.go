...
// CdnReconciler reconciles a Cdn object
...
// +kubebuilder:rbac:groups=cdn.ibm.kubeform.com,resources=cdns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cdn.ibm.kubeform.com,resources=cdns/status,verbs=get;update;patch

func (r *CdnReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("cdn", req.NamespacedName)

	var unstructuredObj unstructured.Unstructured
	unstructuredObj.SetGroupVersionKind(r.Gvk)

	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Cdn")
...
func (r *CdnReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cdnv1alpha1.Cdn{}); err != nil {
			klog.Error(err, "unable to set up auditor", cdnv1alpha1.Cdn{}.APIVersion, cdnv1alpha1.Cdn{}.Kind)
			return err
		}
	}
