...
// +kubebuilder:rbac:groups=app.ibm.kubeform.com,resources=apps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=app.ibm.kubeform.com,resources=apps/status,verbs=get;update;patch
...
func (r *AppReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appv1alpha1.App{}); err != nil {
			klog.Error(err, "unable to set up auditor", appv1alpha1.App{}.APIVersion, appv1alpha1.App{}.Kind)
			return err
		}
	}
