...
// +kubebuilder:rbac:groups=app.ibm.kubeform.com,resources=routes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=app.ibm.kubeform.com,resources=routes/status,verbs=get;update;patch
...
func (r *RouteReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appv1alpha1.Route{}); err != nil {
			klog.Error(err, "unable to set up auditor", appv1alpha1.Route{}.APIVersion, appv1alpha1.Route{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appv1alpha1.Route{}).
