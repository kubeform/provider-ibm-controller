...
// +kubebuilder:rbac:groups=is.ibm.kubeform.com,resources=lbs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=is.ibm.kubeform.com,resources=lbs/status,verbs=get;update;patch
...
func (r *LbReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &isv1alpha1.Lb{}); err != nil {
			klog.Error(err, "unable to set up auditor", isv1alpha1.Lb{}.APIVersion, isv1alpha1.Lb{}.Kind)
			return err
		}
	}
