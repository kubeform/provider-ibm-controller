...
// +kubebuilder:rbac:groups=is.ibm.kubeform.com,resources=vpcs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=is.ibm.kubeform.com,resources=vpcs/status,verbs=get;update;patch
...
func (r *VpcReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &isv1alpha1.Vpc{}); err != nil {
			klog.Error(err, "unable to set up auditor", isv1alpha1.Vpc{}.APIVersion, isv1alpha1.Vpc{}.Kind)
			return err
		}
	}
