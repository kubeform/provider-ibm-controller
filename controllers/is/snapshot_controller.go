...
// +kubebuilder:rbac:groups=is.ibm.kubeform.com,resources=snapshots,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=is.ibm.kubeform.com,resources=snapshots/status,verbs=get;update;patch
...
func (r *SnapshotReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &isv1alpha1.Snapshot{}); err != nil {
			klog.Error(err, "unable to set up auditor", isv1alpha1.Snapshot{}.APIVersion, isv1alpha1.Snapshot{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&isv1alpha1.Snapshot{}).
