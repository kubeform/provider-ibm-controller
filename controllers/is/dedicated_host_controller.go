...
// +kubebuilder:rbac:groups=is.ibm.kubeform.com,resources=dedicatedhosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=is.ibm.kubeform.com,resources=dedicatedhosts/status,verbs=get;update;patch
...
func (r *DedicatedHostReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &isv1alpha1.DedicatedHost{}); err != nil {
			klog.Error(err, "unable to set up auditor", isv1alpha1.DedicatedHost{}.APIVersion, isv1alpha1.DedicatedHost{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&isv1alpha1.DedicatedHost{}).
