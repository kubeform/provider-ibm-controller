...
// +kubebuilder:rbac:groups=is.ibm.kubeform.com,resources=securitygroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=is.ibm.kubeform.com,resources=securitygroups/status,verbs=get;update;patch
...
func (r *SecurityGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &isv1alpha1.SecurityGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", isv1alpha1.SecurityGroup{}.APIVersion, isv1alpha1.SecurityGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&isv1alpha1.SecurityGroup{}).
