...
// +kubebuilder:rbac:groups=function.ibm.kubeform.com,resources=namespaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=function.ibm.kubeform.com,resources=namespaces/status,verbs=get;update;patch
...
func (r *NamespaceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &functionv1alpha1.Namespace{}); err != nil {
			klog.Error(err, "unable to set up auditor", functionv1alpha1.Namespace{}.APIVersion, functionv1alpha1.Namespace{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&functionv1alpha1.Namespace{}).
