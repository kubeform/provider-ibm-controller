...
// +kubebuilder:rbac:groups=kp.ibm.kubeform.com,resources=keys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kp.ibm.kubeform.com,resources=keys/status,verbs=get;update;patch
...
func (r *KeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &kpv1alpha1.Key{}); err != nil {
			klog.Error(err, "unable to set up auditor", kpv1alpha1.Key{}.APIVersion, kpv1alpha1.Key{}.Kind)
			return err
		}
	}
