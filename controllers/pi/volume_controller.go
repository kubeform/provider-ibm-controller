...
// +kubebuilder:rbac:groups=pi.ibm.kubeform.com,resources=volumes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=pi.ibm.kubeform.com,resources=volumes/status,verbs=get;update;patch
...
func (r *VolumeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &piv1alpha1.Volume{}); err != nil {
			klog.Error(err, "unable to set up auditor", piv1alpha1.Volume{}.APIVersion, piv1alpha1.Volume{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&piv1alpha1.Volume{}).
