...
// +kubebuilder:rbac:groups=pi.ibm.kubeform.com,resources=networks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=pi.ibm.kubeform.com,resources=networks/status,verbs=get;update;patch
...
func (r *NetworkReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &piv1alpha1.Network{}); err != nil {
			klog.Error(err, "unable to set up auditor", piv1alpha1.Network{}.APIVersion, piv1alpha1.Network{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&piv1alpha1.Network{}).
