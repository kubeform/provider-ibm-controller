...
// +kubebuilder:rbac:groups=pi.ibm.kubeform.com,resources=keys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=pi.ibm.kubeform.com,resources=keys/status,verbs=get;update;patch
...
func (r *KeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &piv1alpha1.Key{}); err != nil {
			klog.Error(err, "unable to set up auditor", piv1alpha1.Key{}.APIVersion, piv1alpha1.Key{}.Kind)
			return err
		}
	}
