...
// +kubebuilder:rbac:groups=satellite.ibm.kubeform.com,resources=locations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=satellite.ibm.kubeform.com,resources=locations/status,verbs=get;update;patch

func (r *LocationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("location", req.NamespacedName)
...
func (r *LocationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &satellitev1alpha1.Location{}); err != nil {
			klog.Error(err, "unable to set up auditor", satellitev1alpha1.Location{}.APIVersion, satellitev1alpha1.Location{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&satellitev1alpha1.Location{}).
...
func (r *LocationReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Location")
			return nil
		}
		...
		resourceList := &satellitev1alpha1.LocationList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Location")
			return nil
		}
