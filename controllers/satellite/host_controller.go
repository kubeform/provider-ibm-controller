...
// +kubebuilder:rbac:groups=satellite.ibm.kubeform.com,resources=hosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=satellite.ibm.kubeform.com,resources=hosts/status,verbs=get;update;patch
...
func (r *HostReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &satellitev1alpha1.Host{}); err != nil {
			klog.Error(err, "unable to set up auditor", satellitev1alpha1.Host{}.APIVersion, satellitev1alpha1.Host{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&satellitev1alpha1.Host{}).
