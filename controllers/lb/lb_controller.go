...
// LbReconciler reconciles a Lb object
...
// +kubebuilder:rbac:groups=lb.ibm.kubeform.com,resources=lbs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lb.ibm.kubeform.com,resources=lbs/status,verbs=get;update;patch

func (r *LbReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("lb", req.NamespacedName)

	var unstructuredObj unstructured.Unstructured
	unstructuredObj.SetGroupVersionKind(r.Gvk)

	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Lb")
...
func (r *LbReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &lbv1alpha1.Lb{}); err != nil {
			klog.Error(err, "unable to set up auditor", lbv1alpha1.Lb{}.APIVersion, lbv1alpha1.Lb{}.Kind)
			return err
		}
	}
