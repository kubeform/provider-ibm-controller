...
// +kubebuilder:rbac:groups=compute.ibm.kubeform.com,resources=monitors,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.ibm.kubeform.com,resources=monitors/status,verbs=get;update;patch
...
func (r *MonitorReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.Monitor{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.Monitor{}.APIVersion, computev1alpha1.Monitor{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&computev1alpha1.Monitor{}).
