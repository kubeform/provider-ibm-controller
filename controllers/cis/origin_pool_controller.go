...
// OriginPoolReconciler reconciles a OriginPool object
...
// +kubebuilder:rbac:groups=cis.ibm.kubeform.com,resources=originpools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cis.ibm.kubeform.com,resources=originpools/status,verbs=get;update;patch
...
func (r *OriginPoolReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch OriginPool")
...
func (r *OriginPoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cisv1alpha1.OriginPool{}); err != nil {
			klog.Error(err, "unable to set up auditor", cisv1alpha1.OriginPool{}.APIVersion, cisv1alpha1.OriginPool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cisv1alpha1.OriginPool{}).
