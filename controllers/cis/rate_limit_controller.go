...
// +kubebuilder:rbac:groups=cis.ibm.kubeform.com,resources=ratelimits,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cis.ibm.kubeform.com,resources=ratelimits/status,verbs=get;update;patch

func (r *RateLimitReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("ratelimit", req.NamespacedName)
...
func (r *RateLimitReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cisv1alpha1.RateLimit{}); err != nil {
			klog.Error(err, "unable to set up auditor", cisv1alpha1.RateLimit{}.APIVersion, cisv1alpha1.RateLimit{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cisv1alpha1.RateLimit{}).
