...
// +kubebuilder:rbac:groups=ssl.ibm.kubeform.com,resources=certificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssl.ibm.kubeform.com,resources=certificates/status,verbs=get;update;patch
...
func (r *CertificateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sslv1alpha1.Certificate{}); err != nil {
			klog.Error(err, "unable to set up auditor", sslv1alpha1.Certificate{}.APIVersion, sslv1alpha1.Certificate{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sslv1alpha1.Certificate{}).
