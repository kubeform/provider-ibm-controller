...
// +kubebuilder:rbac:groups=cos.ibm.kubeform.com,resources=bucketobjects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cos.ibm.kubeform.com,resources=bucketobjects/status,verbs=get;update;patch
...
func (r *BucketObjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cosv1alpha1.BucketObject{}); err != nil {
			klog.Error(err, "unable to set up auditor", cosv1alpha1.BucketObject{}.APIVersion, cosv1alpha1.BucketObject{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cosv1alpha1.BucketObject{}).
