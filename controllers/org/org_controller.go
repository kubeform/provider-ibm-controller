...
// +kubebuilder:rbac:groups=org.ibm.kubeform.com,resources=orgs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=org.ibm.kubeform.com,resources=orgs/status,verbs=get;update;patch

func (r *OrgReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("org", req.NamespacedName)

	var unstructuredObj unstructured.Unstructured
	unstructuredObj.SetGroupVersionKind(r.Gvk)

	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Org")
...
func (r *OrgReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &orgv1alpha1.Org{}); err != nil {
			klog.Error(err, "unable to set up auditor", orgv1alpha1.Org{}.APIVersion, orgv1alpha1.Org{}.Kind)
			return err
		}
	}
