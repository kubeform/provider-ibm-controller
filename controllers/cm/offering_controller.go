...
// +kubebuilder:rbac:groups=cm.ibm.kubeform.com,resources=offerings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cm.ibm.kubeform.com,resources=offerings/status,verbs=get;update;patch
...
func (r *OfferingReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Offering")
...
func (r *OfferingReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cmv1alpha1.Offering{}); err != nil {
			klog.Error(err, "unable to set up auditor", cmv1alpha1.Offering{}.APIVersion, cmv1alpha1.Offering{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cmv1alpha1.Offering{}).
