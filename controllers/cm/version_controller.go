...
// +kubebuilder:rbac:groups=cm.ibm.kubeform.com,resources=versions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cm.ibm.kubeform.com,resources=versions/status,verbs=get;update;patch
...
func (r *VersionReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cmv1alpha1.Version{}); err != nil {
			klog.Error(err, "unable to set up auditor", cmv1alpha1.Version{}.APIVersion, cmv1alpha1.Version{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cmv1alpha1.Version{}).
