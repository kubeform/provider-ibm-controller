...
// +kubebuilder:rbac:groups=enterprise.ibm.kubeform.com,resources=accounts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=enterprise.ibm.kubeform.com,resources=accounts/status,verbs=get;update;patch
...
func (r *AccountReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &enterprisev1alpha1.Account{}); err != nil {
			klog.Error(err, "unable to set up auditor", enterprisev1alpha1.Account{}.APIVersion, enterprisev1alpha1.Account{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&enterprisev1alpha1.Account{}).
